window.onload=function(){
	a=document.getElementById('tapbar-list');	
	b=document.getElementById('tapbar-tile');
	b.onclick=function(){
		includeLinkStyle("/qzvs/Public/index/css/tapbar.css");
	}
	a.onclick=function(){
		removeLinkStyle("/qzvs/Public/index/css/tapbar.css");
	}
//	b.addEventListener('click',includeLinkStyle,false);
