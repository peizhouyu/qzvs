window.onload=function(){
	a=document.getElementById('dv-list');	
	b=document.getElementById('dv-tile');
	a.onclick=function(){
		removeLinkStyle("/qzvs/Public/index/css/dv-tapbar.css");
	}
	b.onclick=function(){
		includeLinkStyle("/qzvs/Public/index/css/dv-tapbar.css");
	}
