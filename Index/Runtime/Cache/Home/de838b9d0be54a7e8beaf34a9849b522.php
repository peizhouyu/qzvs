...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/qzvs/Public/index/css/search.css"/>
	</head>
	...
	<body>
		...
		<div class="content">
			<div class="navBox">
				<div class="searchBox">
					<form action="<?php echo U('Search/search');?>" method="get">
					<input type="text" name="content" id="content" placeholder="请输入搜索关键字..." class="inputcontent" value="<?php echo ($content); ?>" />
					<input type="submit" class="submit" value="" />
					</form>
				</div>
				<p class="result">搜索<span>"<?php echo ($content); ?>"</span>获得<span><?php echo ($count); ?></span>条结果(用时<span><?php echo ($spendtime); ?></span>秒)</p>
			</div>
				...
				<div class="categoryContent">
						...
						<ul style="margin-top: 48px;">
							<li>
								...
								<div class="categoryLists">
									<?php if(is_array($lab)): $i = 0; $__LIST__ = $lab;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Search/search',array('type'=>'0','lable'=>$vo['labname']));?>"><?php echo ($vo["labname"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
								...
								<div class="categoryLists">
									<a href="<?php echo U('Search/search',array('type'=>'1','time'=>'today'));?>">今天</a>
									<a href="<?php echo U('Search/search',array('type'=>'1','time'=>'week'));?>">最近一周</a>
									<a href="<?php echo U('Search/search',array('type'=>'1','time'=>'month'));?>">最近一月</a>
									<a href="<?php echo U('Search/search',array('type'=>'1','time'=>'year'));?>">最近一年</a>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
								...
								<div class="categoryLists">
									<a href="<?php echo U('Search/search',array('type'=>'2','hot'=>'zan'));?>">评分最高</a>
									<a href="<?php echo U('Search/search',array('type'=>'2','hot'=>'hits'));?>">人气最高</a>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
					...
					<div class="newsList">
						<ul class="newsListBox">
							<?php if(is_array($searchinfo)): $i = 0; $__LIST__ = $searchinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
								<div class="newsitemContent">
									<a href="<?php echo U('Index/play',array('id'=>$vo['videoid']));?>">
										<div class="newsImage">
											<div>
												<img src="<?php echo ($vo["thumb"]); ?>/qzvs/Public/index/img/play.png"/>
											</div>
											<i></i>
