...
<html>
	...
	<head>
		...
		<script src="/qzvs/Public/index/js/movie-tapbar.js" type="text/javascript" charset="utf-8"></script>
	</head>
				...
				<div class="topNavLeft">
					<div class="mainNav">
						<a href="#" class="mainNavs">
							<span class="menu"></span><span>微电影</span>
						</a>
						<div class="dropdown">
							<div class="dropColor">
			...
			<div class="category">
				<div class="categoryContent">
					<div class="categoryTitle">
						<h3>微电影<i>(<?php echo ($count); ?>)</i></h3>
						<div class="categoryChange">
							<div class="changeBox">
								<a href="#" class="list active" id="movie-list"><span></span>列表</a>
								<a href="#" class="tile" id="movie-tile"><span></span>平铺</a>
							</div>
						</div>
					</div>
						...
						<ul>
							<li>
								...
								<div class="categoryLists">
									<?php if(is_array($lab)): $i = 0; $__LIST__ = $lab;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Search/SearchList',array('catid'=>'25','type'=>'0','lable'=>$vo['labname']));?>"><?php echo ($vo["labname"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
								...
								<div class="categoryLists">
									<a href="<?php echo U('Search/SearchList',array('catid'=>'25','type'=>'1','time'=>'today'));?>">今天</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'25','type'=>'1','time'=>'week'));?>">最近一周</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'25','type'=>'1','time'=>'month'));?>">最近一月</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'25','type'=>'1','time'=>'year'));?>">最近一年</a>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
								...
								<div class="categoryLists">
									<a href="<?php echo U('Search/SearchList',array('catid'=>'25','type'=>'2','hot'=>'zan'));?>">评分最高</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'25','type'=>'2','hot'=>'hit'));?>">人气最高</a>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
					...
					<div class="movList">
						<ul class="movListBox">
							<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
								<div class="movitemContent">
									<a href="<?php echo U('Index/play',array('id'=>$vo['id']));?>">
										<div class="movContent_left">
											<img src="<?php echo ($vo["bigpic"]); ?>"/>
											<div class="movContent_left_mask"></div>
										</div>
										<div class="movContent_right">
											<h5><?php echo ($vo["title"]); ?></h5>
											<div>
												<p>导  演:<span><?php echo ($vo["Director"]); ?></span></p>
												<p>主  演:<span><?php echo ($vo["performer"]); ?></span></p>
											</div>
											<p><?php echo ($vo["description"]); ?></p>
											<div class="dataInfo">
												<p class="times"><span></span><?php echo ($vo["hits"]); ?></p>
												<!--<p class="comment"><span></span>123</p>-->
												<p class="praise "onclick="zan(<?php echo ($vo['id']); ?>)" >
													<span></span>
