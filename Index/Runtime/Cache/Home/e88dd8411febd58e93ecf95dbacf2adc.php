				...
				<div class="topNavLeft">
					<div class="mainNav">
						<a href="#" class="mainNavs">
							<span class="menu"></span><span>素材库</span>
						</a>
						<div class="dropdown">
							<div class="dropColor">
						...
						<ul>
							<li>
								...
								<div class="categoryLists">
									<?php if(is_array($lab)): $i = 0; $__LIST__ = $lab;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Search/SearchList',array('catid'=>'31','type'=>'0','lable'=>$vo['labname']));?>"><?php echo ($vo["labname"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
								...
								<div class="categoryLists">
									<a href="<?php echo U('Search/SearchList',array('catid'=>'31','type'=>'1','time'=>'today'));?>">今天</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'31','type'=>'1','time'=>'week'));?>">最近一周</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'31','type'=>'1','time'=>'month'));?>">最近一月</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'31','type'=>'1','time'=>'year'));?>">最近一年</a>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
								...
								<div class="categoryLists">
									<a href="<?php echo U('Search/SearchList',array('catid'=>'31','type'=>'2','hot'=>'zan'));?>">评分最高</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'31','type'=>'2','hot'=>'hit'));?>">人气最高</a>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
