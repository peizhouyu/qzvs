...
<html>
	...
	<head>
		...
		<script src="/qzvs/Public/index/js/dv-tapbar.js" type="text/javascript" charset="utf-8"></script>
	</head>
				...
				<div class="topNavLeft">
					<div class="mainNav">
						<a href="#" class="mainNavs">
							<span class="menu"></span><span>生涯导航</span>
						</a>
						<div class="dropdown">
							<div class="dropColor">
			...
			<div class="category">
				<div class="categoryContent">
					<div class="categoryTitle">
						<h3>生涯导航<i>(<?php echo ($count); ?>)</i></h3>
						<div class="categoryChange">
							<div class="changeBox">
								<a href="#" class="list active" id="dv-list"><span></span>列表</a>
								<a href="#" class="tile" id="dv-tile"><span></span>平铺</a>
							</div>
						</div>
					</div>
						...
						<ul>
							<li>
								...
								<div class="categoryLists">
									<?php if(is_array($lab)): $i = 0; $__LIST__ = $lab;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Search/SearchList',array('catid'=>'29','type'=>'0','lable'=>$vo['labname']));?>"><?php echo ($vo["labname"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
								...
								<div class="categoryLists">
									<a href="<?php echo U('Search/SearchList',array('catid'=>'29','type'=>'1','time'=>'today'));?>">今天</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'29','type'=>'1','time'=>'week'));?>">最近一周</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'29','type'=>'1','time'=>'month'));?>">最近一月</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'29','type'=>'1','time'=>'year'));?>">最近一年</a>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
								...
								<div class="categoryLists">
									<a href="<?php echo U('Search/SearchList',array('catid'=>'29','type'=>'2','hot'=>'zan'));?>">评分最高</a>
									<a href="<?php echo U('Search/SearchList',array('catid'=>'29','type'=>'2','hot'=>'hit'));?>">人气最高</a>
								</div>
							</li>
							<li>
								<div class="categoryListTitle">
									...
									<a href="<?php echo U('Index/play',array('id'=>$vo['id']));?>">
										...
										<div class="dvInfo">
											<div class="dvTitle">
												...
												<div class="dvHeadImg">
													<div>
														<img src="<?php echo ($vo["authorthum"]); ?>"/>
													</div>
												</div>
											</div>
											<div class="dvInfoBox">
												<div class="dvInfoIntro">
													<div class="dvInfoBoxTitle"></div>
													<div class="dvInfoContent">
														<p><?php echo ($vo["description"]); ?></p>
													</div>
												</div>
												<div class="dvInfoAuthor">
													<div class="dvInfoBoxTitle"></div>
													<div class="dvInfoContent">
														<p><?php echo ($vo["directoraim"]); ?></p>
													</div>
												</div>
											</div>
											<div class="dataInfo">
