        ...
        <div class="col-sm-6" style="width:100%;">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="<?php echo U('Video/Change');?>" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="type" id="first" onchange="setSecond(this)">
                                    <?php if(is_array($index)): $i = 0; $__LIST__ = $index;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["catid"]) == $info["catid"]): ?><option value="<?php echo ($vo["catname"]); ?>" selected><?php echo ($vo["catname"]); ?></option><?php endif; ?>
                                        <?php if(($vo["catid"]) != $info["catid"]): ?><option value="<?php echo ($vo["catname"]); ?>" ><?php echo ($vo["catname"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="lable" id="second">
                                    <OPTION VALUE="<?php echo ($info["lable"]); ?>"><?php echo ($info["lable"]); ?></OPTION>
                                </select>
                            </div>
                        </div>
                        <div  class="form-group">
    ...
    function setSecond(obj){
        ...
        switch(val)
        {
            case "微生活":
                ...
                sec.innerHTML = "<?php echo $weishenghuo ;?><option>其他</option>";
                break;
            case "微资讯":
                var sec = document.getElementById('second');
                sec.innerHTML = "<?php echo $weizixun ;?><option>其他</option>";
                break;
            case "微电影":
                var sec = document.getElementById('second');
                sec.innerHTML = "<?php echo $weidianying ;?><option>其他</option>";
                break;
            case "微访谈":
                var sec = document.getElementById('second');
                sec.innerHTML = "<?php echo $weifangtan ;?><option>其他</option>";
                break;
            case "微课堂":
                var sec = document.getElementById('second');
                sec.innerHTML = "<?php echo $weiketang ;?><option>其他</option>";
                break;
            case "微分享":
                var sec = document.getElementById('second');
                sec.innerHTML = "<?php echo $weifenxiang ;?><option>其他</option>";
                break;
            case "生涯导航":
                var sec = document.getElementById('second');
                sec.innerHTML = "<?php echo $shengyadaohang ;?><option>其他</option>";
                break;
            case "素材库":
                var sec = document.getElementById('second');
                sec.innerHTML = "<?php echo $sucaiku ;?><option>其他</option>";
                break;
