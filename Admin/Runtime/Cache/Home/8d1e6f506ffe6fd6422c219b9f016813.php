        ...
        <div class="row">
            <div class="col-sm-6" style="width:100%;">
                <div class="ibox float-e-margins">
                    ...
                    <h5 style="text-align: center;color:red;">注意:填写信息同时需要在“视频文件管理”模块中“上传视频文件”页面上传相应视频</h5>
                         <form class="form-horizontal m-t" id="signupForm" action="<?php echo U('Video/Add');?>" method="post"  enctype="multipart/form-data">
                         ...
                         <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="catname" id="first" onchange="setSecond(this)">
                                        <?php if(is_array($index)): $i = 0; $__LIST__ = $index;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["catname"]); ?>"><?php echo ($vo["catname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div  class="form-group">
                         ...
                         <div  class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="length" class="form-control" placeholder="请输入视频时长（例：00:00）" >
                            </div>
                         </div> 
                         <div class="form-group">
