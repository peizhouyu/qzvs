            ...
            <div class="col-sm-6" style="width:100%;">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><?php echo ($catname); ?>-视频列表</h5>
                        <div class="ibox-tools">
                          <a type="button" class="btn btn-primary J_menuItem"style="margin-top:-8px;" href="<?php echo U('Video/Add');?>" target="_self" >添加视频内容信息</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                         <div class="form-group" >
                                <div class="col-sm-4" style="float:none;margin:0 auto;">
                                 <form action="<?php echo U('Video/search');?>" method="get">

                                    <div class="input-group">
                                    <input type="hidden" class="form-control" name="catname" value="<?php echo ($catname); ?>">
                        ...
                        <table class="table">
                            ...
                            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="<?php echo U('Video/Change',array('id'=>$vo['id']));?>">[修改]</a><a onclick="drop_confirm('确定要删除吗？','<?php echo U('Video/Del',array('id'=>$vo['id'],'catid'=>$vo['catid']));?>')">[删除]</a></td>
